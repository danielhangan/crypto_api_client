    ...
    return (
        <div className='navbar mb-2 flex flex-col h-screen items-start px-12 py-8 space-y-8 shadow data-theme="cupcake"'>
            ...
            <div className='flex flex-col text-xl items-start space-y-2'>
                ...
                <a href="/invoices" className={`link link-hover ${currentPath === 'dashboard' ? 'text-info' : 'text-stone-500'}`}>
                    Invoices
                </a>
                <a href="/clients" className={`link link-hover ${currentPath === 'clients' ? 'text-info' : 'text-stone-500'}`}>
                    Clients
                </a>
                <a href="/projects" className={`link link-hover ${currentPath === 'projects' ? 'text-info' : 'text-stone-500'}`}>
                    Projects
                </a>
            </div>
